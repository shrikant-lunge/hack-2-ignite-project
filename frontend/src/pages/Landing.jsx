          ...
          <div className="features-section">
            ...
            <div className="features-grid">
              <div className="feature-card">
                ...
                <h3>Real-time AQI</h3>
                <p>Monitor air quality levels in your area instantly</p>
              </div>

              <div className="feature-card">
                <div className="feature-icon">🛣️</div>
                <h3>Smart Routing</h3>
                <p>Plan routes avoiding high pollution areas</p>
              </div>

              <div className="feature-card">
                <div className="feature-icon">❤️</div>
                <h3>Health Alerts</h3>
                <p>Get personalized health advisories based on your profile</p>
              </div>
